...
public class FishManager : MonoBehaviour
{
    ...
    void Start ()
    {
        ...
        fishStartPos = GetVector2FromRadius(shark.transform.position, SpawnRadius, MaxFish);
        CreateFish();
	}
	void CreateFish()
    {       
        ...
        {
            GameObject fish = (GameObject)Instantiate(FishPrefab, new Vector3(fishStartPos[i].x, fishStartPos[i].y), Quaternion.identity); //Instantiate a new fish
