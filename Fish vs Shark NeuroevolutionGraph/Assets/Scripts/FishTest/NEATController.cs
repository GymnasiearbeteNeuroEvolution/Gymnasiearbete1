...
namespace FishTest
{
    public class NEATController : MonoBehaviour
    {
        ...
        {
            if (File.Exists(Application.persistentDataPath + string.Format("/{0}.pop.xml", TestSettings.Instance.ProjectName)) && File.Exists(Application.persistentDataPath + string.Format("/{0}.pop.xml", TestSettings.Instance.ProjectName)))
            {
