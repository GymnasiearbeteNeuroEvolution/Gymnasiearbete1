...
{
    // Unity can only use .Net 3.5 or lower versions, hence some adjustments have been made. The original code has not been removed but commented out. See documentation for System.Threading.Tasks here: https://msdn.microsoft.com/en-us/library/system.threading.tasks(v=vs.110).asp
