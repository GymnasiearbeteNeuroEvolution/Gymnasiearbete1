...
{
    public class OrganismExperiment : INeatExperiment
    {
        ...
        public void SetController(NEATControllerOrg ne)
        {
            this.neController = ne;
        }
        ...
        public NeatEvolutionAlgorithm<NeatGenome> CreateEvolutionAlgorithm(IGenomeFactory<NeatGenome> genomeFactory, List<NeatGenome> genomeList)
        {
            ...
            OrganismEvaluator evaluator = new OrganismEvaluator(neController);

            IGenomeDecoder<NeatGenome, IBlackBox> genomeDecoder = CreateGenomeDecoder();


            IGenomeListEvaluator<NeatGenome> innerEvaluator = new UnityParallelListEvaluatorOrganism<NeatGenome, IBlackBox>(genomeDecoder, evaluator, neController);
